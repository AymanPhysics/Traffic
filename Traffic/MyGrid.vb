...
Public Class MyGrid
    ...
    Private Sub MyGrid_CellBeginEdit(sender As Object, e As DataGridViewCellCancelEventArgs) Handles Me.CellBeginEdit

    End Sub


    Public LopHeaderCell As Boolean = False
    ...
    End Sub
    Private Sub MyGrid_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles Me.CellValueChanged
        If LopHeaderCell Then Return
        LopHeaderCell = True
        Me.Rows(e.RowIndex).HeaderCell.Value = (e.RowIndex + 1).ToString
        LopHeaderCell = False
    End Sub
