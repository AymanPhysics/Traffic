...
Partial Public Class TranslateTextAnimationExample
    ...
    Sub save(f As String, v As String)
        bm.ExcuteNonQuery("if not exists(select id from PLevels where id=" & Md.UserName & " and f='" & f & "') insert PLevels(id,f) select " & Md.UserName & ",'" & f & "' update PLevels set v='" & v & "' where id=" & Md.UserName & " and f='" & f & "'")
    End Sub
